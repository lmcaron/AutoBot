...
void take_action()
{
  ...
  else if(regions[2] < d + 7 && regions[3] > d && regions[0] > d){
...
//  Serial.println(GyroZ);
  //lecture ultrason, choix de l'état et action sur le robot 
//  lecture_ultrason();
  ...
  v_robot(170,0);
  Serial.print(error_yaw_rate);
  Serial.print(" / ");
  Serial.println(pid);

//  if(abs((regions[1] - 2) - regions[0]) <= 5 && regions[1] >= 12 && regions[1] <= 17 && regions[0] >= 12 && regions[0] <= 17){
//     v_robot(170,0);
//  }
//  else if((regions[1] - 2) - regions[0] > 5 && regions[1] >= 12 && regions[1] <= 17){
//    v_robot(170,pi/2);
//  }
//  else if((regions[1] - 2) - regions[0] < -5 && regions[1] >= 12 && regions[1] <= 17){
//    v_robot(170,-pi/2);
//  }
//  else if((regions[1] - 2) - regions[0] > 5 && regions[1] > 17){
//    v_robot(170,pi/2);
//  }
//  else if((regions[1] - 2) - regions[0] < -5 && regions[0] > 17){
//    v_robot(170,-pi/2);
//  }
//  else if(abs((regions[1] - 2) - regions[0]) <= 5 && (regions[1] > 17 || regions[0] > 17)){
//    v_robot(170,pi/2);
//  }
//  else if(abs((regions[1] - 2) - regions[0]) <= 5 && (regions[1] < 12 || regions[0] < 12)){
//    v_robot(170,-pi/2);
//  }
//  else if(regions[1] < 12 && regions[0] >= 12){
//    v_robot(150,-pi/2);
//  }
//  else if(regions[0] < 12 && regions[1] >= 12){
//    v_robot(150,pi/2);
//  }
//  else{
//    v_robot(0,0);
...
//  if(!(regions[1] >= 13 && regions[1] <= 15)){
//    correction = (regions[1] - 14)* pi/8;
//  }
//  else{
//    correction = 0;
//  }
//  v_robot(170,correction);
